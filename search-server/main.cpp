...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status_inc = DocumentStatus::ACTUAL) const {
        return FindTopDocuments(raw_query, [status_inc](int document_id, DocumentStatus status_doc, int rating) { return status_inc == status_doc; });
    }
